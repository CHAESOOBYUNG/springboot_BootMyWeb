...
public class PageVO {
	...
	//생성자 - pageVO는 생성될 때, Criteria와 전체 게시글 수 를 받음.
	public PageVO(Criteria cri,int total) {
		//페이지번호, 데이터 개수, 총게시글 수 초기화
		...
		//2. 첫 페이지 계산
		//공식 = 끝 페이지 - 페이지네이션 개수 + 1
		this.start = this.end - 10 + 1;
		
		//3. 실제 끝페이지 번호 계산
		//총 게시글 수가 53개 -> 실제 끝 번호 6, 마지막 페이지 10
		//총 게시글 수가 171개 -> 실제 끝 번호는 18, 마지막 페이지 20
